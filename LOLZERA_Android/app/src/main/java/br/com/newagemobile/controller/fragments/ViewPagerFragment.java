...
public class ViewPagerFragment extends Fragment {
    ...
    ViewPager mPager;
    private String tabtitles[] = new String[]{"Sample Tab 1", "Sample Tab 2", "Sample Tab 3", "Sample Tab 4"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPager.setAdapter(new ViewPagerAdapter(getActivity().getSupportFragmentManager(), tabtitles));
